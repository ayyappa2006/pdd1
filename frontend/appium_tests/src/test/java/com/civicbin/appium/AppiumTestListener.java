...
public class AppiumTestListener extends TestListenerAdapter {
    ...
    public void onFinish(ITestContext context) {
        UnifiedTestReportWriter.writeResults("Appium", results);
    }
    ...
    private void addResult(ITestResult result, String status) {
        ...
        String description = params.length > 1 ? params[1].toString() :
                result.getMethod().getDescription() != null ? result.getMethod().getDescription() : "End-to-End Appium test";
