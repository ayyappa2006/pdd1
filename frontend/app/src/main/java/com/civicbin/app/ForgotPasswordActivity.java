    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(v -> {
            ...
            try {
                ...
                ApiClient.post("user_reset_password.php", payload, new ApiClient.ApiCallback() {
                    @Override
                    public void onSuccess(org.json.JSONObject response) {
                        ...
                        if ("success".equals(response.optString("status"))) {
                            ...
                            Toast.makeText(ForgotPasswordActivity.this, response.optString("message"), Toast.LENGTH_SHORT).show();
                        }
                    }
